...
const HeroOverlay: React.FC<HeroOverlayProps> = ({ isDark, onViewFleet }) => {
  ...
  return (
    ...
    <div className="relative z-10 w-full h-full pointer-events-none flex flex-col justify-between pt-24 md:pt-32 pb-4 px-4 sm:px-6 md:px-12">
      ...
      <div className="flex flex-col lg:flex-row items-end justify-between w-full h-full pb-44 lg:pb-32 gap-6 lg:gap-12 relative">
        
        {/* Main Title Area - Bottom Left */}
        <div className="w-full lg:w-3/5 flex flex-col justify-end pointer-events-none z-10 pb-8 lg:pb-0">
          <div className="pointer-events-auto">
            ...
            >
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl font-black text-slate-900 dark:text-white leading-[0.9] tracking-tighter mb-6 font-['Space_Grotesk'] drop-shadow-2xl">
        ...
        <div className="w-full lg:w-auto flex flex-row gap-4 items-end justify-start md:justify-end pointer-events-auto z-20 overflow-x-auto no-scrollbar pb-2 md:pb-0 pr-4 md:pr-0">
           ...
           <motion.div 
             ...
             className="min-w-[180px] md:min-w-[200px] bg-white/80 dark:bg-black/40 backdrop-blur-xl border border-white/20 p-4 rounded-2xl shadow-xl flex-shrink-0 hover:bg-white/90 dark:hover:bg-black/60 transition-colors"
           >
