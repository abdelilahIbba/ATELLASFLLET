       ...
       <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
             <h2 className="text-3xl font-bold text-brand-navy dark:text-white font-space">
                 Présence <span className="text-brand-teal">Globale</span>
             </h2>
             <p className="text-slate-500 text-sm mt-4 md:mt-0">Retrouvez-nous dans les villes les plus dynamiques du Maroc.</p>
          </div>
