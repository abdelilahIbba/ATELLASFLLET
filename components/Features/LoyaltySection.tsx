...
const LoyaltySection: React.FC = () => {
  const benefits = [
    { icon: Crown, title: "Priority Access", desc: "First access to new arrivals and limited editions." },
    { icon: Star, title: "Points Multiplier", desc: "Earn 2x points on every mile driven." },
    { icon: Key, title: "Keyless Entry", desc: "Unlock any car via the Atellas mobile app." },
    { icon: ShieldCheck, title: "Full Coverage", desc: "Complimentary premium insurance included." }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white font-space mb-6 leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-teal">Driving Privileges</span>
                    </h2>
                    <p className="text-slate-400 mb-8 leading-relaxed max-w-md">
                        Join our exclusive membership program designed for the discerning driver. 
                        Experience seamless bookings, complimentary upgrades, and invitations to exclusive lifestyle events.
                    </p>
                ...
                >
                    <div className="relative z-10 bg-gradient-to-br from-slate-800 to-black border border-white/10 rounded-2xl p-8 aspect-[1.586/1] shadow-2xl flex flex-col justify-between overflow-hidden group hover:scale-105 transition-transform duration-500">
                        ...
                        <div className="relative z-10 flex justify-between items-start">
                             ...
                             <div className="text-xs font-bold text-brand-teal uppercase border border-brand-teal/30 px-2 py-1 rounded">Elite Member</div>
                        </div>
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex justify-between items-end mt-4">
                                ...
                                <div className="text-right">
                                    <div className="text-[10px] text-slate-400 uppercase mb-1">Valid Thru</div>
