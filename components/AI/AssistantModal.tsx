...
const AssistantModal: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Bienvenue chez AeroDrive. Je suis votre Concierge IA. Décrivez votre voyage, et je trouverai le véhicule parfait pour vous.' }
  ]);
          ...
          <div className="p-4 bg-gradient-to-r from-brand-blue/20 to-brand-navy/50 border-b border-white/10 flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-brand-teal uppercase tracking-wider">En Ligne</p>
              </div>
            </div>
