    ...
    <div className={`min-h-screen flex flex-col ${isDark ? 'bg-brand-navy' : 'bg-brand-light'}`}>
      ...
      <section className="pt-32 pb-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            >
                <span className="text-brand-teal font-bold tracking-[0.2em] text-xs uppercase mb-4 block">The Garage</span>
                <h1 className="text-5xl md:text-7xl font-bold text-brand-navy dark:text-white font-space mb-6">
                    Masterpieces in <span className="text-brand-blue">Motion</span>
                </h1>
                <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed">
                    Explore our curated collection of high-performance vehicles. 
                    From track-ready hypercars to executive SUVs, find the perfect companion for your journey.
                </p>
            </motion.div>
        </div>
      </section>
