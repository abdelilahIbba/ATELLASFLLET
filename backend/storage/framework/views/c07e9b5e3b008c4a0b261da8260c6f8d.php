...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Client Management <?php $__env->endSlot(); ?>
     <?php $__env->slot('subtitle', null, []); ?> Manage your customer database <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-cyan-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($users->total()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-emerald-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($users->filter(fn($u) => $u->driver_license_expiry_date && \Carbon\Carbon::parse($u->driver_license_expiry_date)->isFuture())->count()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-amber-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($users->filter(fn($u) => $u->driver_license_expiry_date && \Carbon\Carbon::parse($u->driver_license_expiry_date)->isPast())->count()); ?></p>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-slate-800/30 transition-colors slide-in" style="animation-delay: <?php echo e($index * 0.05); ?>s">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-white"><?php echo e($user->name); ?></p>
                                            <p class="text-xs text-slate-400">Client ID: #<?php echo e($user->id); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-slate-300"><?php echo e($user->email); ?></span>
                                        <span class="text-xs text-slate-500"><?php echo e($user->phone ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="text-sm text-slate-300"><?php echo e($user->national_id ?? 'N/A'); ?></span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-slate-300"><?php echo e($user->driver_license_number ?? 'N/A'); ?></span>
                                        <?php if($user->driver_license_expiry_date): ?>
                                            <span class="text-xs text-slate-500">Exp: <?php echo e(\Carbon\Carbon::parse($user->driver_license_expiry_date)->format('M d, Y')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <?php if($user->driver_license_expiry_date && \Carbon\Carbon::parse($user->driver_license_expiry_date)->isFuture()): ?>
                                    ...
                                    <?php elseif($user->driver_license_expiry_date): ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="<?php echo e(route('admin.clients.show', $user->id)); ?>" class="p-2 hover:bg-cyan-500/10 text-cyan-400 rounded-lg transition-colors" title="View">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                            </svg>
                                        </a>
                                        <a href="<?php echo e(route('admin.clients.edit', $user->id)); ?>" class="p-2 hover:bg-blue-500/10 text-blue-400 rounded-lg transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.clients.destroy', $user->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this client?');">
                                            <?php echo csrf_field(); ?>
    ...
    <div id="addClientModal" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/60 backdrop-blur-sm">
        <div class="glass-morphism max-w-4xl w-full mx-4 rounded-2xl border border-slate-700 slide-in max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('admin.clients.store')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-span-1">
                        ...
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('driver_license_expiry_date'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('driver_license_expiry_date')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/Admin/clients/index.blade.php ENDPATH**/ ?>