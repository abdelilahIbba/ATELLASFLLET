...
<body>
    ...
    <div class="meta">
        <div>
            <strong>Contract #:</strong> <?php echo e($contractNumber); ?><br>
            <strong>Issued:</strong> <?php echo e($issuedAt->format('F d, Y')); ?>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr>
                <th>Email</th>
                <td><?php echo e($booking->client->email); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table>
            <tr>
                <th>Car</th>
                <td><?php echo e($booking->car->make); ?> <?php echo e($booking->car->model); ?></td>
            </tr>
            <tr>
                <th>Daily Price</th>
                <td><?php echo e(number_format($booking->car->daily_price, 2)); ?> Dhs</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table>
            <tr>
                <th>Start</th>
                 <td><?php echo e(\Illuminate\Support\Carbon::parse($booking->start_date)->format('F d, Y')); ?></td>
            </tr>
            <tr>
                <th>End</th>
                 <td><?php echo e(\Illuminate\Support\Carbon::parse($booking->end_date)->format('F d, Y')); ?></td>
            </tr>
        </table>
    </div>
...
<?php /**PATH /var/www/html/resources/views/pdf/booking-contract.blade.php ENDPATH**/ ?>