...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between w-full">
            ...
            <a href="<?php echo e(route('admin.clients.index')); ?>" class="px-6 py-2.5 rounded-xl bg-slate-800 text-slate-300 font-semibold hover:bg-slate-700 transition-colors flex items-center gap-2">
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="glass-morphism rounded-2xl overflow-hidden border border-slate-700">
            <div class="bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 border-b border-slate-700 p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white"><?php echo e($client->name); ?></h2>
                        <p class="text-sm text-slate-400">Client ID: #<?php echo e($client->id); ?></p>
                        <div class="mt-2">
                            <?php if($client->driver_license_expiry_date && \Carbon\Carbon::parse($client->driver_license_expiry_date)->isFuture()): ?>
                            ...
                            <?php elseif($client->driver_license_expiry_date): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-white font-medium">
                            <?php if($client->driver_license_expiry_date): ?>
                                <?php echo e(\Carbon\Carbon::parse($client->driver_license_expiry_date)->format('F d, Y')); ?>

                                <span class="text-sm text-slate-400">
                                    (<?php echo e(\Carbon\Carbon::parse($client->driver_license_expiry_date)->diffForHumans()); ?>)
                                </span>
                            <?php else: ?>
                                N/A
                            <?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-white font-medium"><?php echo e($client->created_at->format('F d, Y')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="<?php echo e(route('admin.clients.edit', $client->id)); ?>" class="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 neon-glow text-center">
                Edit Client
            </a>
            <form action="<?php echo e(route('admin.clients.destroy', $client->id)); ?>" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this client?');">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/Admin/clients/show.blade.php ENDPATH**/ ?>