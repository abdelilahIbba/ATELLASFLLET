                    ...
                    <div class="bg-transparent rounded-lg p-8 mb-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="mt-2 whitespace-pre-wrap"><?php echo e($contact->message); ?></p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-sm text-gray-600">Received on:</p>
                                <p class="font-medium"><?php echo e($contact->created_at->format('F j, Y g:i A')); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/Admin/contacts/show.blade.php ENDPATH**/ ?>