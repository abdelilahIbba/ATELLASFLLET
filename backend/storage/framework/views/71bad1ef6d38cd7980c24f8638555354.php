...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Fleet Management <?php $__env->endSlot(); ?>
     <?php $__env->slot('subtitle', null, []); ?> Manage your vehicle inventory <?php $__env->endSlot(); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between w-full">
            ...
            <a href="<?php echo e(route('admin.cars.create')); ?>" class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 neon-glow flex items-center gap-2">
    ...
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-cyan-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($cars->total()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-emerald-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($cars->where('availability', 'available')->count()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-amber-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($cars->sum('quantity')); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-rose-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($cars->where('availability', 'unavailable')->count()); ?></p>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-slate-800/30 transition-colors slide-in" style="animation-delay: <?php echo e($index * 0.05); ?>s">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        <div class="w-16 h-16 rounded-xl overflow-hidden bg-slate-800 flex-shrink-0">
                                            <?php if($car->image && Storage::disk('public')->exists($car->image)): ?>
                                                <img src="<?php echo e(Storage::url($car->image)); ?>" alt="<?php echo e($car->make); ?> <?php echo e($car->model); ?>" class="w-full h-full object-cover">
                                            <?php else: ?>
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-white"><?php echo e($car->make); ?> <?php echo e($car->model); ?></p>
                                            <p class="text-xs text-slate-400">Model <?php echo e($car->year); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-sm text-slate-300"><?php echo e(ucfirst($car->fuel_type)); ?></span>
                                        <span class="text-xs text-slate-500">Year <?php echo e($car->year); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm">
                                        <p class="font-semibold text-cyan-400"><?php echo e(number_format($car->daily_price, 2)); ?> Dhs</p>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="<?php echo e(route('admin.cars.show', $car->id)); ?>" class="p-2 hover:bg-cyan-500/10 text-cyan-400 rounded-lg transition-colors" title="View">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                            </svg>
                                        </a>
                                        <a href="<?php echo e(route('admin.cars.edit', $car->id)); ?>" class="p-2 hover:bg-blue-500/10 text-blue-400 rounded-lg transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.cars.destroy', $car->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this vehicle?');">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/Admin/cars/index.blade.php ENDPATH**/ ?>