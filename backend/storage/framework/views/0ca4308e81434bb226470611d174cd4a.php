...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Testimonial Management <?php $__env->endSlot(); ?>
     <?php $__env->slot('subtitle', null, []); ?> Manage customer reviews and ratings <?php $__env->endSlot(); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between w-full">
            ...
            <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 neon-glow flex items-center gap-2">
    ...
    <div class="max-w-[1600px] mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-cyan-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($testimonials->total()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-amber-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e(number_format($testimonials->avg('rating') ?? 0, 1)); ?>/5</p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-emerald-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($testimonials->where('is_active', true)->count()); ?></p>
            </div>
            ...
            <div class="glass-morphism rounded-2xl p-6 border-l-2 border-slate-500">
                ...
                <p class="text-3xl font-bold text-white"><?php echo e($testimonials->where('is_active', false)->count()); ?></p>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-slate-800/30 transition-colors slide-in" style="animation-delay: <?php echo e($index * 0.05); ?>s">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <img class="w-10 h-10 rounded-full object-cover border-2 border-cyan-500/30" 
                                             src="<?php echo e($testimonial->image ? asset('storage/' . $testimonial->image) : 'https://ui-avatars.com/api/?name=' . urlencode($testimonial->name)); ?>" 
                                             alt="<?php echo e($testimonial->name); ?>">
                                        <div>
                                            <p class="text-sm font-semibold text-white"><?php echo e($testimonial->name); ?></p>
                                            <p class="text-xs text-slate-400">Review ID: #<?php echo e($testimonial->id); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-sm text-slate-300 line-clamp-2"><?php echo e(Str::limit($testimonial->comment, 100)); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="<?php echo e(route('admin.testimonials.edit', $testimonial)); ?>" class="p-2 hover:bg-blue-500/10 text-blue-400 rounded-lg transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.testimonials.destroy', $testimonial)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this testimonial?');">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/Admin/testimonials/index.blade.php ENDPATH**/ ?>