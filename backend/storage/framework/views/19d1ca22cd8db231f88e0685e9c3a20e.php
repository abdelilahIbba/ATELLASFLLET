                    ...
                    <div x-show="activeSlide === index"
                        ...
                        <div class="absolute inset-0 flex flex-col justify-center px-8 lg:px-16 text-white">
                            ...
                            <div class="flex flex-wrap gap-4">
                                <a href="<?php echo e(route('cars.showAll')); ?>"
            ...
            <div class="relative" x-ref="wrapper" @mouseenter="paused = true" @mouseleave="paused = false">
                ...
                <div class="overflow-hidden">
                    <div class="flex gap-8" x-ref="track" :style="`transform: translateX(${offset}px);`">
                        <?php $__currentLoopData = range(1, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iteration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $cars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="glass rounded-3xl overflow-hidden shadow-2xl glow-border flex flex-col flex-shrink-0 w-[260px] sm:w-[320px] lg:w-[360px]">
                                    <div class="relative">
                                        <img src="<?php echo e(asset('storage/' . $car->image)); ?>" alt="<?php echo e($car->fullName); ?>"
                                            class="w-full h-56 object-cover">
                                        <span class="absolute top-4 right-4 px-4 py-1 rounded-full text-xs font-semibold <?php echo e($isOutOfStock ? 'bg-rose-500/20 text-rose-100' : 'bg-emerald-500/20 text-emerald-200'); ?>">
                                            <?php echo e($isOutOfStock ? 'Unavailable' : 'Available'); ?>

                                        </span>
                                    </div>
                                    <div class="p-6 flex flex-col gap-4 flex-1">
                                        <div>
                                            <h3 class="text-2xl font-bold"><?php echo e($car->fullName); ?></h3>
                                        ...
                                        <div class="text-left">
                                            ...
                                            <p class="text-3xl font-black text-cyan-300"><?php echo e(number_format($car->daily_price, 2)); ?> Dhs
                                                <span class="text-sm text-gray-500">/ day</span>
                                            </p>
                                        </div>
                                        <div class="flex items-center gap-3 text-sm text-gray-300">
                                            <span class="px-3 py-1 rounded-full bg-white/5 border border-white/10"><?php echo e($car->quantity); ?> in
                                                fleet</span>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('car.book', $car)); ?>"
                ...
                <div class="glass rounded-3xl p-6 floating">
                    <div class="w-14 h-14 flex items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400/30 to-blue-500/30 border border-white/10 mb-5">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($reason['icon']); ?>" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold mb-3"><?php echo e($reason['title']); ?></h3>
                    <p class="text-gray-300/80 text-sm"><?php echo e($reason['desc']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
                        ...
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="glass rounded-3xl p-8 shadow-2xl flex-shrink-0 w-[280px] sm:w-[320px]">
                                <div class="flex items-center gap-4 mb-5">
                                    ...
                                    <div>
                                        <p class="text-lg font-bold"><?php echo e($testimonial->name); ?></p>
                                ...
                                <p class="text-gray-300/80 mb-6">“<?php echo e($testimonial->comment); ?>”</p>
                                <p class="text-xs text-gray-500"><?php echo e($testimonial->created_at->format('F d, Y')); ?></p>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <footer class="px-4 lg:px-12 pb-10">
        <div class="glass rounded-3xl p-8 lg:p-12">
            ...
            <div class="mt-8 border-t border-white/10 pt-6 text-center text-xs text-gray-400">
                © <?php echo e(date('Y')); ?> STE BEL ESPACE CAR. Crafted for connoisseurs.
            </div>
        </div>
    </footer>
