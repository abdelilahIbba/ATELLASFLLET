    ...
    <div class="relative h-full flex">
        ...
        <aside class="hidden lg:flex flex-col w-20 glass-morphism border-r border-slate-800/50 relative z-10">
            ...
            <nav class="flex-1 py-8 space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center justify-center h-14 text-slate-400 hover:text-cyan-400 transition-all duration-300 group relative">
                ...
                <div class="relative">
                    <a href="<?php echo e(route('admin.bookings.index')); ?>" class="flex items-center justify-center h-14 bg-cyan-500/10 text-cyan-400 border-l-2 border-cyan-400 relative">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.cars.index')); ?>" class="flex items-center justify-center h-14 text-slate-400 hover:text-cyan-400 transition-all duration-300 group relative">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.clients.index')); ?>" class="flex items-center justify-center h-14 text-slate-400 hover:text-cyan-400 transition-all duration-300 group relative">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="flex items-center justify-center h-14 text-slate-400 hover:text-cyan-400 transition-all duration-300 group relative">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1 overflow-y-auto px-6 lg:px-10 py-8">
                <div class="max-w-[1600px] mx-auto space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="stat-card glass-morphism rounded-2xl p-6 border-l-2 border-<?php echo e($card['color']); ?>-500 slide-in" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                                <div class="flex items-start justify-between mb-4">
                                    <div class="w-12 h-12 rounded-xl bg-<?php echo e($card['color']); ?>-500/10 flex items-center justify-center">
                                        <?php if($card['icon'] === 'calendar'): ?>
                                            <svg class="w-6 h-6 text-<?php echo e($card['color']); ?>-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                            </svg>
                                    ...
                                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-<?php echo e($card['color']); ?>-500/10 text-<?php echo e($card['color']); ?>-400">
                                        <?php echo e($card['delta']); ?>

                                    </span>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-slate-400 mb-1"><?php echo e($card['label']); ?></p>
                    ...
                    <div class="glass-morphism rounded-2xl p-4 flex items-center justify-between flex-wrap gap-4">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2">
                                <?php $__currentLoopData = ['pending' => 'Pending', 'confirmed' => 'Confirmed', 'cancelled' => 'Cancelled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusKey => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="px-4 py-2 rounded-xl text-sm font-medium transition-all <?php echo e($statusKey === 'pending' ? 'bg-amber-500/10 text-amber-300 border border-amber-500/30' : ($statusKey === 'confirmed' ? 'bg-emerald-500/10 text-emerald-300 border border-emerald-500/30' : 'bg-rose-500/10 text-rose-300 border border-rose-500/30')); ?>">
                                        <span class="inline-block w-2 h-2 rounded-full <?php echo e($statusKey === 'pending' ? 'bg-amber-400' : ($statusKey === 'confirmed' ? 'bg-emerald-400' : 'bg-rose-400')); ?> mr-2 status-dot"></span>
                                        <?php echo e($label); ?>
                        ...
                        <a href="<?php echo e(route('admin.bookings.create')); ?>" class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 text-white font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all duration-300 neon-glow flex items-center gap-2">
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-slate-800/50">
                                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-slate-800/30 transition-colors slide-in" style="animation-delay: <?php echo e(($index * 0.05) + 0.4); ?>s">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span class="text-sm text-slate-300 font-mono">BK-<?php echo e(str_pad($booking->id, 5, '0', STR_PAD_LEFT)); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div>
                                                    <p class="text-sm font-semibold text-white"><?php echo e($booking->car->make); ?> <?php echo e($booking->car->model); ?></p>
                                                    <p class="text-xs text-slate-400"><?php echo e($booking->car->year); ?></p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div>
                                                    <p class="text-sm font-medium text-white"><?php echo e($booking->client->name); ?></p>
                                                    <p class="text-xs text-slate-400"><?php echo e($booking->client->email); ?></p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="text-sm">
                                                    <p class="text-slate-300"><?php echo e(\Carbon\Carbon::parse($booking->start_date)->format('d M Y')); ?></p>
                                                    <p class="text-xs text-slate-500">to <?php echo e(\Carbon\Carbon::parse($booking->end_date)->format('d M Y')); ?></p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold border <?php echo e($statusStyles[$booking->status] ?? 'bg-slate-500/10 text-slate-300 border-slate-500/30'); ?>">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-2" x-data="{ showActions: false, showModal: false }">
                                                    <a href="<?php echo e(route('admin.bookings.show', $booking->id)); ?>" class="p-2 hover:bg-cyan-500/10 text-cyan-400 rounded-lg transition-colors" title="View">
                                                            ...
                                                            <div class="glass-morphism max-w-2xl w-full rounded-2xl p-8 border border-slate-700">
                                                                <div class="flex items-start justify-between mb-6">
                                                                    <div>
                                                                        ...
                                                                        <p class="text-slate-400"><?php echo e($booking->car->make); ?> <?php echo e($booking->car->model); ?></p>
                                                                    </div>
                                                                ...
                                                                <div class="grid grid-cols-2 gap-4 mb-6">
                                                                    ...
                                                                    <div class="glass-card p-4 rounded-xl">
                                                                        ...
                                                                        <p class="text-sm font-medium text-white"><?php echo e(number_format($booking->car->daily_price, 2)); ?> Dhs</p>
                                                                    </div>
                                                                    <div class="glass-card p-4 rounded-xl">
                                                                        <p class="text-xs text-slate-400 mb-1">Start Date</p>
                                                                        <p class="text-sm font-medium text-white"><?php echo e(\Carbon\Carbon::parse($booking->start_date)->format('d M Y')); ?></p>
                                                                    </div>
                                                                    <div class="glass-card p-4 rounded-xl">
                                                                        <p class="text-xs text-slate-400 mb-1">End Date</p>
                                                                        <p class="text-sm font-medium text-white"><?php echo e(\Carbon\Carbon::parse($booking->end_date)->format('d M Y')); ?></p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="flex gap-3">
                                                                    ...
                                                                    <a href="<?php echo e(route('admin.bookings.contract', $booking->id)); ?>" target="_blank" class="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold hover:shadow-lg hover:shadow-cyan-500/30 transition-all">
                                                                        Download PDF
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <button @click="showActions = !showActions" class="relative p-2 hover:bg-slate-700/50 text-slate-400 rounded-lg transition-colors">
                                                        ...
                                                        <div x-show="showActions" x-cloak @click.away="showActions = false" class="absolute right-0 mt-2 w-48 glass-morphism rounded-xl shadow-lg py-2 z-10">
                                                            ...
                                                            <?php endif; ?>
                                                            <form action="<?php echo e(route('admin.bookings.destroy', $booking->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this booking?');">
                                                                <?php echo csrf_field(); ?>
