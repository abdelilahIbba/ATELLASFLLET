...
<header class="h-16 glass-morphism border-b border-slate-800 sticky top-0 z-30">
    <div class="h-full px-6 flex items-center justify-between">
        <!-- Page Title -->
        <div>
            <h1 class="text-xl font-bold gradient-text"><?php echo e($title); ?></h1>
        </div>
        ...
        <div class="flex items-center gap-4">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" 
                     ...
                     x-cloak>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-sm text-slate-300 hover:bg-slate-800 transition-colors">
...
<?php /**PATH /var/www/html/resources/views/components/admin/topbar.blade.php ENDPATH**/ ?>