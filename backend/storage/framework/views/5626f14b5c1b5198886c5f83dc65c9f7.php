...
<head>
  ...
  <title>Vos Accès Démo — <?php echo e($fromName); ?></title>
  <style>
...
<div class="wrapper">
  <table class="main" role="presentation" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="body">
        <p class="greeting">Bonjour, <?php echo e($demo->client_name); ?> 👋</p>
        <p class="intro">
          Nous avons le plaisir de vous accorder un <strong>accès démo administrateur</strong> à la plateforme
          <strong><?php echo e($fromName); ?></strong>. Explorez librement toutes les fonctionnalités de gestion
        ...
        <div class="trial-box">
          ...
          <div class="trial-value"><?php echo e($demo->plan); ?></div>
          <div class="trial-expire">Expire le <strong><?php echo e($demo->expires_at->format('d/m/Y')); ?></strong></div>
        </div>
        ...
        <div class="credentials-box">
          ...
          <div class="cred-row">
            ...
            <span class="cred-value"><?php echo e($demo->email); ?></span>
          </div>

          <div class="cred-row">
            <span class="cred-label">Clé d'Accès (Mot de passe)</span>
            <span class="cred-value key"><?php echo e($demo->access_key); ?></span>
          </div>
        </div>

        
        <div class="cta-wrapper">
          <a href="<?php echo e($loginUrl); ?>" class="cta-button">Accéder au Tableau de Bord →</a>
        </div>
    ...
    <tr>
      <td class="footer">
        ...
        <p>
          ...
          <a href="mailto:<?php echo e($fromAddress); ?>"><?php echo e($fromAddress); ?></a>
        </p>
      </td>
    </tr>
...
<?php /**PATH /var/www/html/resources/views/emails/demo-credentials.blade.php ENDPATH**/ ?>