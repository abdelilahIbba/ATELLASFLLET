...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="greeting">
            Bonjour <strong><?php echo e($booking->user?->name ?? 'Client'); ?></strong>,<br>
        ...
        <div class="vehicle-card">
            <div style="font-size:28px; font-weight:900; color:#2563eb; font-family:monospace; letter-spacing:2px;">#<?php echo e(str_pad($booking->id, 4, '0', STR_PAD_LEFT)); ?></div>
            <div style="font-size:12px; color:#64748b; margin-top:4px;">Créée le <?php echo e($booking->created_at?->format('d/m/Y à H:i') ?? now()->format('d/m/Y')); ?></div>
        </div>

        
        <div class="section-title">Véhicule réservé</div>
        <div class="vehicle-card">
            <div class="vehicle-name"><?php echo e($booking->car?->make); ?> <?php echo e($booking->car?->model); ?></div>
            <div class="vehicle-meta"><?php echo e($booking->car?->year); ?> &bull; <?php echo e($booking->car?->fuel_type); ?></div>
            <?php if($booking->unit_number): ?>
            <div style="margin-top:8px; font-size:12px; color:#64748b;">Unité nº<?php echo e($booking->unit_number); ?>

                <?php if($booking->car?->unit_plates && isset($booking->car->unit_plates[$booking->unit_number - 1])): ?>
                &mdash; Immat. <?php echo e($booking->car->unit_plates[$booking->unit_number - 1]); ?>
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value"><?php echo e(\Carbon\Carbon::parse($booking->start_date)->format('d/m/Y')); ?></div>
            </div>
            <div class="info-item">
                <div class="info-label">Retour</div>
                <div class="info-value"><?php echo e(\Carbon\Carbon::parse($booking->end_date)->format('d/m/Y')); ?></div>
            </div>
        </div>
        ...
        <div class="vehicle-card">
            <table class="cost-table">
                <tr>
                    <td class="label"><?php echo e($daily); ?> × <?php echo e($days); ?> jour<?php echo e($days > 1 ? 's' : ''); ?></td>
                    <td class="amount"><?php echo e(number_format($subtotal, 2)); ?> MAD</td>
                </tr>
                <tr>
                    <td class="label">Taxes (<?php echo e($taxRate); ?>%)</td>
                    <td class="amount"><?php echo e(number_format($taxAmt, 2)); ?> MAD</td>
                </tr>
                <tr>
                    <td class="label">Dépôt de garantie (<?php echo e($depRate); ?>%)</td>
                    <td class="amount"><?php echo e(number_format($depAmt, 2)); ?> MAD</td>
                </tr>
                <tr class="divider"><td colspan="2"></td></tr>
                <tr class="total">
                    <td class="label">Total</td>
                    <td class="amount"><?php echo e(number_format($total, 2)); ?> MAD</td>
                </tr>
            </table>
        </div>
        ...
        <div class="gps-box">
            📍 <?php echo e($booking->pickup_address ?: 'Position GPS confirmée'); ?><br>
            <span style="font-family:monospace; font-size:12px;">
                Lat : <?php echo e($booking->pickup_latitude); ?> &bull; Long : <?php echo e($booking->pickup_longitude); ?>
    ...
    <div class="footer">
        <p>Vous recevez cet email car vous avez effectué une réservation sur <strong><?php echo e(config('app.name')); ?></strong>.</p>
        <p>Pour toute question : <a href="mailto:<?php echo e(config('mail.from.address')); ?>"><?php echo e(config('mail.from.address')); ?></a></p>
        <p style="margin-top:12px; font-size:11px; color:#cbd5e1;">© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Tous droits réservés.</p>
    </div>

</div>
</body>
</html>
<?php /**PATH /var/www/html/resources/views/emails/reservation_confirmation.blade.php ENDPATH**/ ?>