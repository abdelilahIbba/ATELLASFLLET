...
const HeroOverlay: React.FC<HeroOverlayProps> = ({ isDark, onViewFleet }) => {
  ...
  return (
    ...
    <div className="relative z-20 w-full h-full pointer-events-none px-4 sm:px-6 md:px-8">
      <div className="w-full lg:px-16 xl:px-20 2xl:px-28 mx-auto h-full grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:gap-10 pt-24 md:pt-28 pb-12 md:pb-14">
