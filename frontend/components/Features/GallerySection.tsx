...
const GallerySection: React.FC = () => {
  return (
    <section className="py-24 bg-brand-light dark:bg-brand-navy transition-colors duration-700 overflow-hidden">
      <div className="w-full lg:px-16 xl:px-20 2xl:px-28 mx-auto px-6 mb-12 text-center">
         <span className="text-brand-teal font-bold tracking-widest text-xs uppercase mb-2 block">La Galerie</span>
         <h2 className="text-4xl font-bold text-brand-navy dark:text-white font-space">
            Excellence <span className="text-brand-blue">Visuelle</span>
         </h2>
      </div>
