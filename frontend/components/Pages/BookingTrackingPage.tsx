      ...
      <Navbar 
        ...
        onLogout={onLogout}
            />
              ...
              <main className="relative flex-1 min-h-[calc(100vh-84px)] overflow-hidden pt-28 pb-10">
                  <div className="relative z-30 px-4 sm:px-6 pointer-events-none">
                      <div className="w-full lg:px-16 xl:px-20 2xl:px-28 mx-auto flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between items-start">
          ...
          <div className="relative z-10 pointer-events-none px-4 sm:px-6 mt-8">
              <div className="w-full lg:px-16 xl:px-20 2xl:px-28 mx-auto min-h-[calc(100vh-280px)] flex flex-col justify-end lg:flex-row lg:justify-between lg:items-end gap-4 lg:gap-6">
