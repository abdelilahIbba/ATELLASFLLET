    ...
    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            {[
                ...
                { val: 'ExpiringDocs', label: '⚠ Docs Expirant' },
            ].map(({ val, label }) => (
                <button 
                    key={val}
                    ...
                    className={`px-3 py-2 rounded-lg text-xs font-bold uppercase transition-colors ${
                        vehicleFilter === val
                          ...
                          : val === 'ExpiringDocs'
                            ? 'bg-orange-100 dark:bg-orange-500/10 text-orange-600 dark:text-orange-400 hover:bg-orange-200 dark:hover:bg-orange-500/20'
