  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <button
          ...
          className={`border rounded-xl p-4 flex items-center justify-between transition-all text-left w-full ${
            expiringDocsCount > 0
              ? 'bg-orange-100 dark:bg-orange-500/10 border-orange-200 dark:border-orange-500/20 hover:border-orange-400 hover:shadow-md cursor-pointer'
              : 'bg-slate-50 dark:bg-white/5 border-slate-100 dark:border-white/5 cursor-default'
          }`}
        >
            <div>
                ...
                {expiringDocsCount > 0 && (
                  <p className="text-[10px] text-orange-500 font-medium mt-0.5">Cliquer pour filtrer →</p>
                )}
            </div>
